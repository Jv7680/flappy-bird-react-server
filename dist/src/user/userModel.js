...
const checkUserNameExist = (userName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let [userRows] = yield pool.execute(`select * from ${TABLE_NAME} where userName = ?`, [userName]);
...
const checkGmailExist = (gmail) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let [userRows] = yield pool.execute(`select * from ${TABLE_NAME} where gmail = ?`, [gmail]);
        if (userRows.length === 0) {
            return false;
        }
...
const checkFullNameExist = (fullName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let [userRows] = yield pool.execute(`select * from ${TABLE_NAME} where fullName = ?`, [fullName]);
        if (userRows.length === 0) {
            return false;
        }
...
const getRankList = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let [rankList] = yield pool.execute(`select fullName, bestScore from ${TABLE_NAME} order by bestScore desc`);
...
const createUser = (userData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield pool.execute(`insert into ${TABLE_NAME}(userName,password,fullName,gmail,accountType,bestScore,setting,refreshToken) values (?,?,?,?,?,?,?,?)`, Object.values(userData));
...
let resetUserPassword = (userName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield pool.execute(`update ${TABLE_NAME} set password = ? where userName = ?`, [hashPassword, userName]);
        return newPassword;
    }
    catch (error) {
...
const updateUserDetail = (userData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield pool.execute(`update ${TABLE_NAME} set fullName = ?, gmail = ? where userName = ?`, Object.values(userData));
        return true;
    }
    catch (error) {
        console.log("createUser error", error);
...
const updateUserPassword = (userPasswordData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield pool.execute(`update ${TABLE_NAME} set password = ? where userName = ?`, Object.values(userPasswordData));
        return true;
    }
    catch (error) {
        console.log("createUser error", error);
...
const updateUserBestScore = (userName, bestScore) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield pool.execute(`update ${TABLE_NAME} set bestScore = ? where userName = ?`, [bestScore, userName]);
        return true;
    }
    catch (error) {
...
const updateUserRefreshToken = (userName, refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield pool.execute(`update ${TABLE_NAME} set refreshToken = ? where userName = ?`, [refreshToken, userName]);
        return true;
    }
    catch (error) {
        console.log("updateUserRefreshToken error", error);
